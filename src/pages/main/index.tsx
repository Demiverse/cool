			...
			<div className={styles.container}>
				...
				<div className={styles.content}>
					...
					<p>
						...
						историями. Неудивительно, что на грядущий День всех влюблённых Антуанетта ди Делис
						решила воспользоваться поводом и собрать влиятельных лиц Сарнаута именно здесь. И герой
						Сарнаута тоже приглашён.
					</p>
					<p>
						Портал alloder.ru анонсирует интерактивную игру в жанре визуальной новеллы. В ней вы сможете
