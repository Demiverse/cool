				...
				<main className={styles.character}>
					...
					<div className={styles.about}>
						...
						<p className={styles.text}>
							Антуанетта — нынешняя королева эльфов, избранная посредством голосования на Великом Балу в 1020 году. Элегантная, импозантная, раскованная последовательница гедонизма всегда рада новым знакомствам. А её познания дипломатического искусства столь велики, что помогают найти выход даже из самой сложной ситуации. И уж для героя Сарнаута у Антуанетты точно найдётся минутка, чтобы преподать весьма важный урок в его жизни.
						</p>
