				...
				<main className={styles.character}>
					...
					<div className={styles.about}>
						...
						<p className={styles.text}>
							Великая Волшебница Смеяна по праву считается одним из флагманов маготехнического развития Сарнаута. Изобретения из её мастерских пользуются популярностью во всём мире. Даже лапотники из дальних канийских деревень слышали об этой женщине властных нравов. Кроме того, Владычица имеет свою академию в Глиморе, где обучают премудростям маготехники. И она хотела бы распространять образование и дальше — чтобы искоренить невежество среди простого люда.
						</p>
